...
const sendMail = async (user, type, details = {}) => {
  ...
  try {
    ...
    const subject = type === "OTP" ? "Your OTP Code - Secure Login" : `Welcome to $${appName}!`;

    const text = type === "OTP"
      ? `Dear user,\n\nYour OTP code is: ${otpCode}. This code will expire in 1 minute. Please do not share it with anyone for security reasons.\n\nThank you for using ${appName}!\nBest regards,\nThe ${appName} Team`
      : `Hello,\n\nThank you for choosing $${appName}! We're excited to have you with us.\n\nIf you have any questions, feel free to reach out!\nBest regards,\nThe ${appName} Team`;
    ...
    switch (type) {
      case "OTP":
        html = `<div style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6;">
          ...
          <p style="color: #888;">Thank you for using ${appName}!</p>
          <p style="color: #888;">Best regards,<br />The ${appName} Team</p>
        </div>`
        break;
      case "WELCOME":
        html = `<div style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6;">
          <h2 style="color: #4CAF50;">Welcome to ${appName}!</h2>
          <p>We're excited to have you with us. ${appName} helps you manage and organize your links easily and securely.</p>
    ...
    const info = await transporter.sendMail({
      from: `"${appName} By Ascedium" <${process.env.GMAIL_USER}>`,
      to: user,
      subject,
      text,
      html,
