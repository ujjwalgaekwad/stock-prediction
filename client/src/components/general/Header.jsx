...
const Header = () => {
  ...
  return (
    <>
      <nav className="lg:h-[4.5rem] fixed top-0 w-full bg-zinc-200 dark:bg-zinc-900 h-16 lg:py-5 pt-4 pb-[1rem] flex justify-between items-center space-x-2 px-5 lg:px-20 border-b-[1px] border-zinc-300 dark:border-zinc-700 select-none">
        <Link
          to="/"
